...
from attack_engine import dir_enum, sub_enum, get_robots, get_sitemap, href_spider, form_spider, http_header_data, shodan_scan
...
def scan_results():
    if request.method == 'POST':
        ...
        return render_template(
            ...
            # ----- Shodan Data List ---------- #
            shodan_Data_list = shodan_Data,
            shodan_Data_list_len = len(shodan_Data),
            # --------------------------------- #
